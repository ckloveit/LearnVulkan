...
{
	VkPresentModeKHR bestMode = VK_PRESENT_MODE_FIFO_KHR; // VSync - SwapChain
	for (const auto& availablePresentMode : availablePresentModes)
	{
		if (availablePresentMode == VK_PRESENT_MODE_MAILBOX_KHR) // Triple Buffer - SwapChain
		{
			return availablePresentMode;
		}
		else if (availablePresentMode == VK_PRESENT_MODE_IMMEDIATE_KHR) // Immedtate - SwapChain
		{
...
private:
	...
	void PickPhysicalDevice()
	{
		...
		{
			throw std::runtime_error("failed to find a suit GPU");
		}
	}
	...
	void Cleanup()
	{
		...
		vkDestroySurfaceKHR(instance, surface, nullptr); // make surface destroy before instance destroy
	...
	*	we can destroy the shader modules again as soon as pipeline creation is finished
	*/
