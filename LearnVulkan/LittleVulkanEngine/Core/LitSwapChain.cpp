...
namespace Lit
{
	...
	LitSwapChain::LitSwapChain(LitDevice& deviceRef, VkExtent2D inWindowExtent, std::shared_ptr<LitSwapChain> previousSwapChain)
		: device(deviceRef), windowExtent(inWindowExtent), oldSwapChain(previousSwapChain)
	{
		Init();
